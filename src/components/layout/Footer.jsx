    ...
    <footer className="bg-secondary-900 text-white">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Blockstar</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-secondary-300 text-sm">
                ...
                <span>+1 (312) 555-0151</span>
              </li>
              <li className="flex items-center text-secondary-300 text-sm">
                <FiMail className="mr-2" />
                <span>contact@myblockstar.com</span>
              </li>
              <li className="flex items-center text-secondary-300 text-sm">
                <FiMapPin className="mr-2" />
                <span>318 W Adams St, Chicago, Illinois 60606, US</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-secondary-700 mt-8 pt-8 text-center text-secondary-300 text-sm">
          <p>&copy; {new Date().getFullYear()} Blockstar. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
